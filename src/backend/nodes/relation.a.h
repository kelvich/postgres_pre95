...
extern Rel MakeRel ARGS((int lasslis Makelasslis(ndexkey Makendexkey(rderin Makerderin(lauseinf Makelauseinf(oininf Makeoininf(nnerjoi Makennerjoi(Make(innerjoin));
extern Make ARGS((int TLE MakeTLE(resdom, Node expr));
