...
extern void set_temprelDesc ARGS((ScanTemp node, Relation temprelDesc));
extern Relation get_temprelDesc ARGS((ScanTemp node));
extern void set_scantempState ARGS((ScanTemp node,ScanTempState scantempState));
extern ScanTempState get_scantempState ARGS((ScanTemp node));
