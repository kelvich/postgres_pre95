...
extern void set_temprelDescs ARGS((ScanTemps node, List temprelDescs));
extern List get_temprelDescs ARGS((ScanTemps node));
extern void set_scantempState ARGS((ScanTemps node,ScanTempState scantempState));
...
extern void PrintChoose ARGS((FILE *fp, Choose node));
extern bool EqualChoose ARGS((FILE *fp, Choose node));
