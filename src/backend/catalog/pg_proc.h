...
DATA(insert OID = 197 (  rt_poly_union     6 11 f t f 2 603 foo bar ));
DATA(insert OID = 198 (  rt_poly_inter     6 11 f t f 2 603 foo bar ));
DATA(insert OID = 199 (  rt_poly_size      6 11 f t f 1  23 foo bar ));
...
DATA(insert OID = 710 (  pg_username       6 11 f t t 0  19 foo bar ));
DATA(insert OID = 711 (  userfntest        6 11 f t t 1  23 foo bar ));
