...
DATA(insert OID = 195 (  rt_box_size       PGUID 11 f t f 1 f 23 "603" 100 0 0 100  foo bar ));
DATA(insert OID = 196 (  rt_bigbox_size    PGUID 11 f t f 1 f 23 "603" 100 0 0 100  foo bar ));
