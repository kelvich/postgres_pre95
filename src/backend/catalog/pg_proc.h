...
DATA(insert OID = 940 (  oidchar16in	   PGUID 11 f t f 1 f 911 "0" 100 0 0 100  foo bar));
DATA(insert OID = 941 (  oidchar16out	   PGUID 11 f t f 1 f 19 "0" 100 0 0 100  foo bar));
