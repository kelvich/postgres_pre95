...
DATA(insert OID = 95 (  "<"        6 0 b t f  21  21  16 520 524 0 0 int2lt intltsel intltjoinsel ));
...
DATA(insert OID = 518 (  "!="      6 0 b t f  23  23  16 518  96  0  0 int4ne neqsel neqjoinsel ));
DATA(insert OID = 519 (  "!="      6 0 b t f  21  21  16 519  94  0  0 int2ne neqsel neqjoinsel ));
DATA(insert OID = 520 (  ">"       6 0 b t f  21  21  16  95   0  0  0 int2gt intgtsel intltjoinsel ));
DATA(insert OID = 521 (  ">"       6 0 b t f  23  23  16  97   0  0  0 int4gt intgtsel intltjoinsel ));
DATA(insert OID = 522 (  "<="      6 0 b t f  21  21  16 524 520  0  0 int2le intltsel intltjoinsel ));
DATA(insert OID = 523 (  "<="      6 0 b t f  23  23  16 525 521  0  0 int4le intltsel intltjoinsel ));
DATA(insert OID = 524 (  ">="      6 0 b t f  21  21  16 522  95  0  0 int2ge intgtsel intltjoinsel ));
DATA(insert OID = 525 (  ">="      6 0 b t f  23  23  16 523  97  0  0 int4ge intgtsel intltjoinsel ));
...
DATA(insert OID = 534 (  "<"       6 0 b t f  21  23  16 537 542  0  0 int24lt intltsel intltjoinsel ));
DATA(insert OID = 535 (  "<"       6 0 b t f  23  21  16 536 543  0  0 int42lt intltsel intltjoinsel ));
DATA(insert OID = 536 (  ">"       6 0 b t f  21  23  16 535 540  0  0 int24gt intgtsel intgtjoinsel ));
DATA(insert OID = 537 (  ">"       6 0 b t f  23  21  16 534 541  0  0 int42lt intgtsel intgtjoinsel ));
DATA(insert OID = 538 (  "!="      6 0 b t f  21  23  16 539 532  0  0 int24ne neqsel neqjoinsel ));
DATA(insert OID = 539 (  "!="      6 0 b t f  23  21  16 538 533  0  0 int42ne neqsel neqjoinsel ));
DATA(insert OID = 540 (  "<="      6 0 b t f  21  23  16 543 536  0  0 int24le intltsel intltjoinsel ));
DATA(insert OID = 541 (  "<="      6 0 b t f  23  21  16 542 537  0  0 int42le intltsel intltjoinsel ));
DATA(insert OID = 542 (  ">="      6 0 b t f  21  23  16 541 534  0  0 int24ge intgtsel intgtjoinsel ));
DATA(insert OID = 543 (  ">="      6 0 b t f  23  21  16 540 535  0  0 int42ge intgtsel intgtjoinsel ));
DATA(insert OID = 544 (  "*"       6 0 b t f  21  23  23 545   0  0  0 int24mul intltsel intltjoinsel ));
DATA(insert OID = 545 (  "*"       6 0 b t f  23  21  23 544   0  0  0 int42mul intltsel intltjoinsel ));
DATA(insert OID = 546 (  "/"       6 0 b t f  21  23  23   0   0  0  0 int24div intltsel intltjoinsel ));
DATA(insert OID = 547 (  "/"       6 0 b t f  23  21  23   0   0  0  0 int42div intltsel intltjoinsel ));
DATA(insert OID = 548 (  "%"       0 0 b t f  21  23  23   6   0  0  0 int24mod intltsel intltjoinsel ));
DATA(insert OID = 549 (  "%"       0 0 b t f  23  21  23   6   0  0  0 int42mod intltsel intltjoinsel ));
...
DATA(insert OID = 569 (  ">"       6 0 b t f 703 703  16 568 570 0 0 reltimegt - - ));
DATA(insert OID = 570 (  "<="      6 0 b t f 703 703  16 571 569 0 0 reltimele - - ));
DATA(insert OID = 571 (  ">="      6 0 b t f 703 703  16 570 568 0 0 reltimege - - ));
...
DATA(insert OID = 581 (  "+"       6 0 b t f 702 703 702 581   0 0 0 timepl - - ));
DATA(insert OID = 582 (  "-"       6 0 b t f 702 703 702   0   0 0 0 timemi - - ));
...
DATA(insert OID = 608 (  "!="      6 0 b t f  26  26  16 608 607  0  0 oidneq eqsel eqjoinsel ));
DATA(insert OID = 609 (  "<"       6 0 b t f  26  26  16 610 612  0  0 int4lt intltsel intltjoinsel ));
DATA(insert OID = 610 (  ">"       6 0 b t f  26  26  16 609 611  0  0 int4gt intgtsel intltjoinsel ));
DATA(insert OID = 611 (  "<="      6 0 b t f  26  26  16 612 610  0  0 int4le intltsel intltjoinsel ));
DATA(insert OID = 612 (  ">="      6 0 b t f  26  26  16 611 609  0  0 int4ge intgtsel intltjoinsel ));
DATA(insert OID = 620 (  "="       6 0 b t t  700  700  16 620 621  622 622 float4eq eqsel eqjoinsel ));
DATA(insert OID = 621 (  "!="      6 0 b t f  700  700  16 621 620  0 0 float4ne eqsel eqjoinsel ));
DATA(insert OID = 622 (  "<"       6 0 b t f  700  700  16 623 625  0 0 float4lt intltsel intltjoinsel ));
DATA(insert OID = 623 (  ">"       6 0 b t f  700  700  16 622 624  0 0 float4gt intgtsel intltjoinsel ));
DATA(insert OID = 624 (  "<="      6 0 b t f  700  700  16 625 623  0 0 float4le intltsel intltjoinsel ));
DATA(insert OID = 625 (  ">="      6 0 b t f  700  700  16 624 622  0 0 float4ge intgtsel intltjoinsel ));
