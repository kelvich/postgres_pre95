...
DATA(insert OID = 91 (  "="        6 0 b t f  16  16  16  91   0  0  0 booleq eqsel eqjoinsel ));
DATA(insert OID = 92 (  "="        6 0 b t f  18  18  16  92 630  0  0 chareq eqsel eqjoinsel ));
DATA(insert OID = 93 (  "="        6 0 b t f  19  19  16  93   0  0  0 char16eq eqsel eqjoinsel ));
DATA(insert OID = 94 (  "="        6 0 b t f  21  21  16  94 519 95 95 int2eq eqsel eqjoinsel ));
DATA(insert OID = 95 (  "<"        6 0 b t f  21  21  16 520 524 95 95 int2lt intltsel intltjoinsel ));
DATA(insert OID = 96 (  "="        6 0 b t f  23  23  16  96 518 97 97 int4eq eqsel eqjoinsel ));
DATA(insert OID = 97 (  "<"        6 0 b t f  23  23  16 521 525 97 97 int4lt intltsel intltjoinsel ));
DATA(insert OID = 98 (  "="        6 0 b t f  25  25  16  98 531  0  0 texteq eqsel eqjoinsel ));
...
DATA(insert OID = 503 (  "="       6 0 b t f 603 603  16   0   0   0   0 box_eq areasel areajoinsel ));
...
DATA(insert OID = 532 (  "="       6 0 b t f  21  23  16 533 538  95  97 int24eq eqsel eqjoinsel ));
DATA(insert OID = 533 (  "="       6 0 b t f  23  21  16 532 539  97  95 int42eq eqsel eqjoinsel ));
...
DATA(insert OID = 558 (  "="       6 0 b t f  26  26  16 558 559   0   0 oideq intltsel intltjoinsel ));
DATA(insert OID = 559 (  "!="      6 0 b t f  26  26  16 559 558   0   0 oidneq neqsel neqjoinsel ));
DATA(insert OID = 560 (  "="       6 0 b t f 702 702  16 560 561 562 562 abstimeeq - - ));
...
DATA(insert OID = 566 (  "="       6 0 b t f 703 703  16 566 567 568 568 reltimeeq - - ));
...
DATA(insert OID = 572 (  "="       6 0 b t f 704 704  16 572   0   0   0 intervaleq - - ));
...
DATA(insert OID = 607 (  "="       6 0 b t f  26  26  16 607 608  97  97 oideq eqsel eqjoinsel ));
...
DATA(insert OID = 620 (  "="       6 0 b t f  700  700  16 620 621  622 622 float4eq eqsel eqjoinsel ));
