...
DATA(insert OID = 520 (  ">"       6 0 b t f  21  21  16  95   0  0  0 int2gt intgtsel intgtjoinsel ));
...
DATA(insert OID = 524 (  ">="      6 0 b t f  21  21  16 522  95  0  0 int2ge intgtsel intgtjoinsel ));
DATA(insert OID = 525 (  ">="      6 0 b t f  23  23  16 523  97  0  0 int4ge intgtsel intgtjoinsel ));
...
DATA(insert OID = 610 (  ">"       6 0 b t f  26  26  16 609 611  0  0 int4gt intgtsel intgtjoinsel ));
DATA(insert OID = 611 (  "<="      6 0 b t f  26  26  16 612 610  0  0 int4le intltsel intltjoinsel ));
DATA(insert OID = 612 (  ">="      6 0 b t f  26  26  16 611 609  0  0 int4ge intgtsel intgtjoinsel ));
...
DATA(insert OID = 623 (  ">"       6 0 b t f  700  700  16 622 624  0 0 float4gt intgtsel intgtjoinsel ));
