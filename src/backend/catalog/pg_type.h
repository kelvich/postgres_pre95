...
DATA(insert OID = 28 (  xid        6  4  12 t b t \054 0   0 xidin xidout xidin xidout - ));
DATA(insert OID = 29 (  cid        6  2   3 t b t \054 0   0 cidin cidout cidin cidout - ));
...
DATA(insert OID = 702 (  abstime   6  4  20 t b t \054 0   0 nabstimein nabstimeout nabstimein nabstimeout - ));
...
DATA(insert OID = 910 (  oidint4    6  8  20 f b t \054 0   0 oidint4in oidint4out oidint4in oidint4out - ));
DATA(insert OID = 911 (  oidchar16  6  20 20 f b t \054 0   0 oidchar16in oidchar16out oidchar16in oidchar16out - ));
...
DATA(insert OID = 1002 (  _char      6 -1  -1 f b t \054 0  18 array_in textout array_in textout - ));
...
DATA(insert OID = 1028 (  _oid       6 -1  -1 f b t \054 0  26 array_in array_out array_in array_out - ));
