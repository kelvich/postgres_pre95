...
extern int prsabsdate ARGS((char *timestr, struct tm *tm, int *tzp));
extern int tryabsdate ARGS((char *fields[], int nf, struct tm *tm, int *tzp));
...
extern int32 abstimeeq ARGS((AbsoluteTime t1, AbsoluteTime t2));
extern int32 abstimene ARGS((AbsoluteTime t1, AbsoluteTime t2));
extern int32 abstimelt ARGS((AbsoluteTime t1, AbsoluteTime t2));
extern int32 abstimegt ARGS((AbsoluteTime t1, AbsoluteTime t2));
extern int32 abstimele ARGS((AbsoluteTime t1, AbsoluteTime t2));
extern int32 abstimege ARGS((AbsoluteTime t1, AbsoluteTime t2));
