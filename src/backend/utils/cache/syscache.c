...
static struct cachedesc cacheinfo[] = {
	...
	{ &TypeRelationName,			/* TYPNAME */
	  ...
	  { TypeNameAttributeNumber,
	    ...
	    0,
	    0 },
	  sizeof(struct type) - sizeof(struct varlena) },
 ...
 */
LispValue
SearchSysCacheGetAttribute(cacheId, attributeNumber,
			   key1, key2, key3, key4)
	int		cacheId;
	...
	char 		*key1, *key2, *key3, *key4;
{
	...
	attributeValue = amgetattr(tp, (Buffer) 0, attributeNumber,
	...
	if (attributeByValue) {
		...
		int	size =
			(attributeLength < 0)
				...
				? VARSIZE((struct varlena *) attributeValue)
	...
	LispValue	lispTypId;
{
	...
	type = (struct type *) GETSTRUCT(typeTuple);
