...
/* ----------------------------------------------------------------
 *	         obsolete heap access method interface
 * ----------------------------------------------------------------
 */
...
{
    return
	heap_create(relationName, archiveMode, numberOfAttributes,
		    tupleDescriptor);
}
...
RelationNameCreateTemporaryRelation(relationName, numberOfAttributes,
    ...
    TupleDescriptor	tupleDescriptor;
{
    return (heap_creatr(relationName, numberOfAttributes, tupleDescriptor));
}
...
Relation
ObjectIdOpenHeapRelation(relationId)
    ObjectId	relationId;
{
    /* ----------------
     *	increment access statistics
    ...
    Name	relationName;
{
    ...
    return (heap_openr(relationName));
}
...
RelationGetHeapTupleByItemPointer(relation, qual, heapItem, bufferOutP)
    ...
    Buffer	*bufferOutP;
{
    return (heap_fetch(relation, qual, heapItem, bufferOutP));
}
...
RelationInsertHeapTuple(relation, heapTuple, offsetOutP)
    ...
    double	*offsetOutP;
{
    return (heap_insert(relation, heapTuple, offsetOutP));
}
...
RelationDeleteHeapTuple(relation, heapItem)
    ...
    ItemPointer	heapItem;
{
    return (heap_delete(relation, heapItem));
}
...
RelationReplaceHeapTuple(relation, heapItem, tuple, offsetOutP)
    ...
    double	*offsetOutP;
{
    return (heap_replace(relation, heapItem, tuple, offsetOutP));
}
...
{
    return
	PointerGetDatum(heap_getattr(tuple, buffer, attributeNumber,
...
RelationBeginHeapScan(relation, startScanAtEnd, qual, numberOfKeys, key)
    ...
    ScanKey	key;
{
    return heap_beginscan(relation, startScanAtEnd, qual, numberOfKeys, key);
}
...
HeapScanGetNextTuple(scan, backwards, bufferOutP)
    ...
    Buffer		*bufferOutP;
{
    return (heap_getnext(scan, backwards, bufferOutP));
}
