...
extern LispValue group_clauses_by_indexkey ARGS((LispValue rel, LispValue index, LispValue indexkeys, LispValue classes, LispValue clauseinfo_list, bool join));

extern CInfo match_clause_to_indexkey ARGS((LispValue rel, LispValue index, LispValue indexkey, LispValue xclass, LispValue clauses, bool join));
