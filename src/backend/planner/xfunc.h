...
extern int xfunc_shouldpull ARGS((Path childpath, JoinPath parentpath, CInfo *maxclausept, int whichchild));
...
extern int xfunc_total_path_cost ARGS((Path pathnode));
extern double xfunc_cost_per_tuple ARGS((JoinPath joinnode, int whichrel));
