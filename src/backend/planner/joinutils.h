...
extern LispValue match_pathkey_joinkeys ARGS((LispValue pathkey, LispValue joinkeys, LispValue which_subkey));
extern LispValue match_paths_joinkeys ARGS((LispValue joinkeys, LispValue ordering, LispValue paths, LispValue which_subkey));
